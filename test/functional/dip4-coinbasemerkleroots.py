...
from test_framework.test_framework import GavecoinTestFramework
...
class LLMQCoinbaseCommitmentsTest(GavecoinTestFramework):
    def set_test_params(self):
        self.set_gavecoin_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as GavecoinTestFramework doesn't support this atm)
