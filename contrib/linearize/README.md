# Linearize
Construct a linear, no-fork, best version of the Gavecoin blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install gavecoin_hash

https://github.com/gavecoin/gavecoin_hash
...
JSON-RPC server. Running `gavecoind` or `gavecoin-qt -server` will be sufficient.
...
* `input`: gavecoind blocks/ directory containing blkNNNNN.dat
