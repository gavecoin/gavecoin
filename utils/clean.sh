...
rm -rf test_bitcoin.coverage/ gavecoin-gtest.coverage/ total.coverage/
...
clean_exe src/gavecoin-cli
clean_exe src/gavecoind
clean_exe src/gavecoin-gtest
clean_exe src/gavecoin-tx
