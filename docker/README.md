...
official/supported Docker Images found at https://hub.docker.com/r/gavecoin/gavecoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/gavecoin/gavecoind-develop/ when changing the above text**