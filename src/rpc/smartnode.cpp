...
void smartnode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the smartnode owner Gavecoin address\n"
            "  payee          - Print the smartnode payout Gavecoin address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the smartnode operator public key\n"
            "  status         - Print smartnode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the smartnode voting Gavecoin address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "gavecoin",               "smartnode",             &smartnode,             true,  {} },
    { "gavecoin",               "smartnodelist",         &smartnodelist,         true,  {} },
};
