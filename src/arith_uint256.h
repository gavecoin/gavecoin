...
#ifndef GAVECOIN_ARITH_UINT256_H
#define GAVECOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Gavecoin only uses this "compact" format for encoding difficulty
...
#endif // GAVECOIN_ARITH_UINT256_H
