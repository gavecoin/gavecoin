...
{
    const char* pszTimestamp = "We generated this genesis block on 07/02/2022 and we are proud of it";
    const CScript genesisOutputScript = CScript() << ParseHex("04552f0e2faffa5c0c933ab8a84e2ca3cef7712c1681649842ba5f6a3b9f917bba17e3fed9d373ea36f3c77670a599e87b58be3e286f4d17b241a5aee29ce433a1") << OP_CHECKSIG;
...
public:
    CMainParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 1047200;
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gavecoin: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Gavecoin: 2 minutes
         ...
         */
        pchMessageStart[0] = 0x38;//r
        pchMessageStart[1] = 0x23;//t
        pchMessageStart[2] = 0x70;//m
        pchMessageStart[3] = 0x33;//.
        nDefaultPort = 11116;
        nPruneAfterHeight = 100000;
        //FindMainNetGenesisBlock(1656782276, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1656782276, 1307, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb02a4bac4bc32d128432c752a6c4bd66ec2bb92bd08e47f8b5e1d0b9fc6638a7"));
        assert(genesis.hashMerkleRoot == uint256S("0xb32bb0d647efdc127efb03b49eedfebe3f2563949a6e888433531b9ece0b446b"));

        vSeeds.emplace_back("dn01.gavecoin.com", true);
        vSeeds.emplace_back("dn02.gavecoin.com", true);
        vSeeds.emplace_back("dn03.gavecoin.com", true);
        vSeeds.emplace_back("dn04.gavecoin.com", true);


        // Gavecoin addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,38);
        // Gavecoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,71);
        // Gavecoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,28);
        // Gavecoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Gavecoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Gavecoin BIP44 coin type is '5'
        nExtCoinType = gArgs.GetArg("-extcoinindex", 200);
        nExtCoinType = nExtCoinType == 0 ? 200 : nExtCoinType;
        vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 1}// 1% founder/dev fee forever
                                        										   };
        ...
        vSporkAddresses = {"Gav39XVwheN5HUdq5ZUWzLpBcYK3NyrmcR"};
        nMinSporkKeys = 1;
        fBIP9CheckSmartnodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            {
                {0, uint256S("0xb02a4bac4bc32d128432c752a6c4bd66ec2bb92bd08e47f8b5e1d0b9fc6638a7")}
           }
        };

        chainTxData = ChainTxData{
        	1656782695, // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
     ...
     //   consensus.DIP0003EnforcementHeight = 7300;
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gavecoin: 1 day
        consensus.nPowTargetSpacing = 60; // Gavecoin: 1 minutes
        ...
        //FindMainNetGenesisBlock(1656782774,  0x20001fff, "test");
        genesis = CreateGenesisBlock(1656782774, 146, 0x20001fff, 4, 5000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfeb912a5ddcfc2a9adb3bf436e1607cd17c12d5cac7971eefef4d61e80c82b96"));
        assert(genesis.hashMerkleRoot == uint256S("0xb32bb0d647efdc127efb03b49eedfebe3f2563949a6e888433531b9ece0b446b"));
        ...
        vSeeds.emplace_back("212.86.108.204", true);
        vSeeds.emplace_back("212.86.108.206", true);

        // Testnet Gavecoin addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,123);
        // Testnet Gavecoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Gavecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Gavecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Gavecoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 10227;
        ...
        vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 1}// 5% founder/dev fee forever
                                                										   };
        ...
        chainTxData = ChainTxData{
        	1656782776, // * UNIX timestamp of last known number of transactions (Block 213054)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Gavecoin: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Gavecoin: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
		consensus.DGWBlocksAvg = 60;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("gavecoinevo.org",  "devnet-seed.gavecoinevo.org"));

        // Testnet Gavecoin addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Gavecoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Gavecoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Gavecoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Gavecoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Gavecoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
