    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  gavecoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Gavecoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 GVC, 1 GVC, 10 GVC, 100 GVC and 1000 GVC -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.gavecoin.org/en/stable/wallets/gavecoincore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
