    ...
    signalled(false)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Gavecoin block chain.").arg(tr(PACKAGE_NAME)) + " " +
...
bool Intro::pickDataDirectory()
{
     ...
     * override -datadir in the gavecoin.conf file in the default data directory
     * (to be consistent with gavecoind behavior)
     */
