...
Below are some notes on how to build Gavecoin Core for Windows.
...
way. This will install to `c:\workspace\gavecoin`, for example:

    make install DESTDIR=/mnt/c/workspace/gavecoin
