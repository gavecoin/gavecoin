...
This mechanism has been integrated into Bitcore-Node-Gavecoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gavecoin/insight-api-gavecoin#web-socket-api](https://github.com/gavecoin/insight-api-gavecoin#web-socket-api)
* API: [https://github.com/gavecoin/insight-api-gavecoin#instantsend-transactions](https://github.com/gavecoin/insight-api-gavecoin#instantsend-transactions)
