Gavecoin Core version 0.14.0.4
==========================
...
A bug in Gavecoin Core caused respends to not work before a received InstantSend transaction was confirmed in at least
one block. This is fixed in this release, so that InstantSend locked mempool transactions can be
respent immediately in Gavecoin Core (other wallets were not affected).
...
Previously, Gavecoin would re-request old transactions even though they were already known locally. This
...
in Bitcoin v0.15.1. This release of Gavecoin Core includes a backport of this fix.


0.14.0.4 Change log
===================

See detailed [set of changes](https://github.com/gavecoin/gavecoin/compare/v0.14.0.3...gavecoin:v0.14.0.4).

- [`5f98ed7a5`](https://github.com/gavecoin/gavecoin/commit/5f98ed7a5) [v0.14.0.x] Bump version to 0.14.0.4 and draft release notes (#3203)
- [`c0dda38fe`](https://github.com/gavecoin/gavecoin/commit/c0dda38fe) Circumvent BIP69 sorting in fundrawtransaction.py test (#3100)
- [`64ae6365f`](https://github.com/gavecoin/gavecoin/commit/64ae6365f) Fix compile issues
- [`36473015b`](https://github.com/gavecoin/gavecoin/commit/36473015b) Merge #11397: net: Improve and document SOCKS code
- [`66e298728`](https://github.com/gavecoin/gavecoin/commit/66e298728) Slightly optimize ApproximateBestSubset and its usage for PS txes (#3184)
- [`16b6b6f7c`](https://github.com/gavecoin/gavecoin/commit/16b6b6f7c) Update activemn if protx info changed (#3176)
- [`ce6687130`](https://github.com/gavecoin/gavecoin/commit/ce6687130) Actually update spent index on DisconnectBlock (#3167)
- [`9b49bfda8`](https://github.com/gavecoin/gavecoin/commit/9b49bfda8) Only track last seen time instead of first and last seen time (#3165)
- [`ad720eef1`](https://github.com/gavecoin/gavecoin/commit/ad720eef1) Merge #17118: build: depends macOS: point --sysroot to SDK (#3161)
- [`909d6a4ba`](https://github.com/gavecoin/gavecoin/commit/909d6a4ba) Simulate BlockConnected/BlockDisconnected for PS caches
- [`db7f471c7`](https://github.com/gavecoin/gavecoin/commit/db7f471c7) Few fixes related to SelectCoinsGroupedByAddresses (#3144)
- [`1acd4742c`](https://github.com/gavecoin/gavecoin/commit/1acd4742c) Various fixes for mixing queues (#3138)
- [`0031d6b04`](https://github.com/gavecoin/gavecoin/commit/0031d6b04) Also consider txindex for transactions in AlreadyHave() (#3126)
- [`c4be5ac4d`](https://github.com/gavecoin/gavecoin/commit/c4be5ac4d) Ignore recent rejects filter for locked txes (#3124)
- [`f2d401aa8`](https://github.com/gavecoin/gavecoin/commit/f2d401aa8) Make orphan TX map limiting dependent on total TX size instead of TX count (#3121)
- [`87ff566a0`](https://github.com/gavecoin/gavecoin/commit/87ff566a0) Update/modernize macOS plist (#3074)
- [`2141d5f9d`](https://github.com/gavecoin/gavecoin/commit/2141d5f9d) Fix bip69 vs change position issue (#3063)
- [`75fddde67`](https://github.com/gavecoin/gavecoin/commit/75fddde67) Partially revert 3061 (#3150)
- [`c74f2cd8b`](https://github.com/gavecoin/gavecoin/commit/c74f2cd8b) Fix SelectCoinsMinConf to allow instant respends (#3061)
- [`2e7ec2369`](https://github.com/gavecoin/gavecoin/commit/2e7ec2369) [0.14.0.x] Remove check for mempool size in CInstantSendManager::CheckCanLock (#3119)
