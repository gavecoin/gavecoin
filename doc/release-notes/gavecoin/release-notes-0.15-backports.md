...
- [`595826ad6`](https://github.com/gavecoin/gavecoin/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`b451094e2`](https://github.com/gavecoin/gavecoin/commit/b451094e2) Merge #11490: Disconnect from outbound peers with bad headers chains
...
- [`6ec77c0a7`](https://github.com/gavecoin/gavecoin/commit/6ec77c0a7) Merge #11131: rpc: Write authcookie atomically
...
- [`17bb230d7`](https://github.com/gavecoin/gavecoin/commit/17bb230d7) Merge #11121: TestNode tidyups
...
- [`c438c9322`](https://github.com/gavecoin/gavecoin/commit/c438c9322) Merge #11022: Basic keypool topup
...
- [`40617436c`](https://github.com/gavecoin/gavecoin/commit/40617436c) Merge #10179: Give CValidationInterface Support for calling notifications on the CScheduler Thread
...
- [`746ebf165`](https://github.com/gavecoin/gavecoin/commit/746ebf165) fix indendation in wallet.cpp
...
- [`106fdfa0b`](https://github.com/gavecoin/gavecoin/commit/106fdfa0b) Fix tests
...
- [`2ada45284`](https://github.com/gavecoin/gavecoin/commit/2ada45284) Merge #10864: Avoid redundant redeclaration of GetWarnings(const string&)
...
- [`445e8d85c`](https://github.com/gavecoin/gavecoin/commit/445e8d85c) Merge #10807: getbalance example covers at least 6 confirms
...
- [`5ac5e66f3`](https://github.com/gavecoin/gavecoin/commit/5ac5e66f3) remove unneeded space wallet.cpp
...
- [`aa364bf7a`](https://github.com/gavecoin/gavecoin/commit/aa364bf7a) Merge #10555: [tests] various improvements to zmq_test.py
...
- [`b92d2dd66`](https://github.com/gavecoin/gavecoin/commit/b92d2dd66) Merge #10545: Use list initialization (C++11) for maps/vectors instead of boost::assign::map_list_of/list_of
...
- [`44a55019b`](https://github.com/gavecoin/gavecoin/commit/44a55019b) Merge #10478: rpc: Add listen address to incoming connections in `getpeerinfo`
...
- [`ea3afb995`](https://github.com/gavecoin/gavecoin/commit/ea3afb995) Merge #10433: [tests] improve tmpdir structure
...
- [`badfdb451`](https://github.com/gavecoin/gavecoin/commit/badfdb451) Fix rpc param names
...
- [`73a5d9bfd`](https://github.com/gavecoin/gavecoin/commit/73a5d9bfd) add `--quiet` to `test_runner.py`, replicates bitcoin#10105
...
- [`46db8eb68`](https://github.com/gavecoin/gavecoin/commit/46db8eb68) Merge #10168: Fix build warning from #error text
...
- [`b645757be`](https://github.com/gavecoin/gavecoin/commit/b645757be) Call RemoveConflictedTx from BlockConnected instead of ProcessNewTransaction
...
- [`0b232fd1c`](https://github.com/gavecoin/gavecoin/commit/0b232fd1c) Merge #10208: [wallet] Rescan abortability
- [`55d1251ff`](https://github.com/gavecoin/gavecoin/commit/55d1251ff) Merge #9480: De-duplicate SignatureCacheHasher
- [`29194b1f5`](https://github.com/gavecoin/gavecoin/commit/29194b1f5) Backport Bitcoin#9424, Bitcoin#10123 and Bitcoin#10153 (#2918)
- [`15fa1873d`](https://github.com/gavecoin/gavecoin/commit/15fa1873d) Drop redundant imports and fix related code
- [`6f91144f2`](https://github.com/gavecoin/gavecoin/commit/6f91144f2) Fix p2p-fingerprint.py
- [`92fed9254`](https://github.com/gavecoin/gavecoin/commit/92fed9254) Fix and re-enable pruning.py
- [`bfeb5bca4`](https://github.com/gavecoin/gavecoin/commit/bfeb5bca4) fix txindex.py and add it to extended scripts
- [`c37008a45`](https://github.com/gavecoin/gavecoin/commit/c37008a45) update dip4-coinbasemerkalroots.py and llmq-is-cl-conflicts.py
- [`7fd979cc0`](https://github.com/gavecoin/gavecoin/commit/7fd979cc0) Merge #10114: [tests] sync_with_ping should assert that ping hasn't timed out
- [`4121daba2`](https://github.com/gavecoin/gavecoin/commit/4121daba2) Merge #10098: Make qt wallet test compatible with qt4
- [`cc06ef551`](https://github.com/gavecoin/gavecoin/commit/cc06ef551) Merge #10109: Remove SingleNodeConnCB
- [`94aa904c0`](https://github.com/gavecoin/gavecoin/commit/94aa904c0) Merge #10107: Remove unused variable. Remove accidental trailing semicolons in Python code
- [`404e244d1`](https://github.com/gavecoin/gavecoin/commit/404e244d1) Merge #10088: Trivial: move several relay options into the relay help group
- [`05cb5a058`](https://github.com/gavecoin/gavecoin/commit/05cb5a058) Merge #10108: ApproximateBestSubset should take inputs by reference, not value
- [`bfd63c179`](https://github.com/gavecoin/gavecoin/commit/bfd63c179) Merge #10076: [qa] combine_logs: Use ordered list for logfiles
- [`e57559a8d`](https://github.com/gavecoin/gavecoin/commit/e57559a8d) Merge #10096: Check that all test scripts in test/functional are being run
- [`c2258978b`](https://github.com/gavecoin/gavecoin/commit/c2258978b) Merge #10057: [init] Deduplicated sigaction() boilerplate
- [`6bb55d547`](https://github.com/gavecoin/gavecoin/commit/6bb55d547) Merge #10056: [zmq] Call va_end() on va_start()ed args.
- [`142b5cba0`](https://github.com/gavecoin/gavecoin/commit/142b5cba0) Merge #10073: Actually run assumevalid.py
- [`14001a3d9`](https://github.com/gavecoin/gavecoin/commit/14001a3d9) Merge #10085: Docs: remove 'noconnect' option
- [`120941793`](https://github.com/gavecoin/gavecoin/commit/120941793) Merge #10083: [QA] Renaming rawTx into rawtx
- [`1781c7a70`](https://github.com/gavecoin/gavecoin/commit/1781c7a70) Merge #10069: [QA] Fix typo in fundrawtransaction test
- [`379312931`](https://github.com/gavecoin/gavecoin/commit/379312931) Merge #9946: Fix build errors if spaces in path or parent directory
- [`ba20c9031`](https://github.com/gavecoin/gavecoin/commit/ba20c9031) Merge #10067: [trivial] Dead code removal
- [`ae05068c5`](https://github.com/gavecoin/gavecoin/commit/ae05068c5) Merge #10053: [test] Allow functional test cases to be skipped
- [`9f07f489d`](https://github.com/gavecoin/gavecoin/commit/9f07f489d) Merge #10047: [tests] Remove unused variables and imports
- [`96a5f5730`](https://github.com/gavecoin/gavecoin/commit/96a5f5730) Merge #9500: [Qt][RPC] Autocomplete commands for 'help' command in debug console
- [`07e0567dc`](https://github.com/gavecoin/gavecoin/commit/07e0567dc) Merge #9558: Clarify assumptions made about when BlockCheck is called
- [`2aa3f890d`](https://github.com/gavecoin/gavecoin/commit/2aa3f890d) Merge #10029: Fix parameter naming inconsistencies between .h and .cpp files
- [`7edb9e15a`](https://github.com/gavecoin/gavecoin/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/gavecoin/gavecoin/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/gavecoin/gavecoin/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/gavecoin/gavecoin/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/gavecoin/gavecoin/commit/67c735b15) s/bitcoin-config.h/gavecoin-config.h/
- [`2f63322cd`](https://github.com/gavecoin/gavecoin/commit/2f63322cd) gavecoinify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/gavecoin/gavecoin/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/gavecoin/gavecoin/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/gavecoin/gavecoin/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/gavecoin/gavecoin/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/gavecoin/gavecoin/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/gavecoin/gavecoin/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/gavecoin/gavecoin/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/gavecoin/gavecoin/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/gavecoin/gavecoin/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/gavecoin/gavecoin/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/gavecoin/gavecoin/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/gavecoin/gavecoin/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/gavecoin/gavecoin/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/gavecoin/gavecoin/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/gavecoin/gavecoin/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/gavecoin/gavecoin/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/gavecoin/gavecoin/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/gavecoin/gavecoin/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/gavecoin/gavecoin/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/gavecoin/gavecoin/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/gavecoin/gavecoin/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/gavecoin/gavecoin/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/gavecoin/gavecoin/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/gavecoin/gavecoin/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/gavecoin/gavecoin/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/gavecoin/gavecoin/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/gavecoin/gavecoin/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/gavecoin/gavecoin/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/gavecoin/gavecoin/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/gavecoin/gavecoin/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/gavecoin/gavecoin/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/gavecoin/gavecoin/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/gavecoin/gavecoin/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/gavecoin/gavecoin/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/gavecoin/gavecoin/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/gavecoin/gavecoin/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/gavecoin/gavecoin/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/gavecoin/gavecoin/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/gavecoin/gavecoin/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/gavecoin/gavecoin/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/gavecoin/gavecoin/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/gavecoin/gavecoin/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/gavecoin/gavecoin/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/gavecoin/gavecoin/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/gavecoin/gavecoin/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/gavecoin/gavecoin/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/gavecoin/gavecoin/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/gavecoin/gavecoin/commit/1cfda206a) Merge #9993: Initialize nRelockTime
