Gavecoin Core version 0.12.3.4
==========================
...
When deployed on testnet, it is required to start with a fresh data directory or call Gavecoin Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/gavecoin/gavecoin/compare/v0.12.3.3...gavecoin:v0.12.3.4).
