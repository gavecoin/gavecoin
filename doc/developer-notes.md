...
Gavecoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Gavecoin Core, where everyone uses
...
pay attention to for reviewers of Gavecoin Core code.

General Gavecoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Gavecoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
...
be sent upstream but bugfixes may also be prudent to PR against Gavecoin Core so that they can be integrated
