UNIX BUILD NOTES
====================
Some notes on how to build Gavecoin Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

Base build dependencies
-----------------------
Building the dependencies and Gavecoin Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your Gavecoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Gavecoin Core should be built with a non-executable stack
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, Gavecoin Core may be compiled in
