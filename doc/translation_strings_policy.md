...
This document provides guidelines for internationalization of the Gavecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gavecoin_en.ts` remains unchanged.
