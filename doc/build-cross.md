Cross-compiliation of Gavecoin Core
===============================

Gavecoin Core can be cross-compiled on Linux to all other supported host systems. This is done by changing
the `HOST` parameter when building the dependencies and then specifying another `--prefix` directory when building Gavecoin.
...
When building Gavecoin Core, use
